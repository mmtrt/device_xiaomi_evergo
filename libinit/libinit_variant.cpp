...
#define PRODSM_PROP "ro.product.system.model"
...
void set_variant_props(const variant_info_t variant) {
    ...
    if (variant.bid_value == "S98016AA1") {
        ...
        property_override(PRODSM_PROP, "21091116AI");
    }
